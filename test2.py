...
def fillScrollArea(area, arr):
    ...
    # font.setBold(True)
    font.setItalic(True)
    font.setPointSize(12)  # Increase the font size to 14
    labelS.setFont(font)
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        setLabel(self.labelTime, 10, 20, "labelTime")
    ...
    def plot(self, highlighted_index):
        ...
        # Adjust the figure size to fill the available space
        ...
        ax.bar(self.x, self.lst, color=colors, width=1.0)
        ...
        plt.subplots_adjust(left=0.02, right=1, bottom=0.02)  # Increase the bottom margin to accommodate the legend
        # plt.subplots_adjust(left=0.02, right=0.02, bottom=0.02)
        # Redraw the canvas
        self.canvas.draw()
    ...
    def plot_diabled(self):
        ...
        self.figure.clear()
        ax = self.figure.add_subplot(111)
        self.figure.set_figwidth(6)  # Adjust the width as desired
        self.figure.set_figheight(4)  # Adjust the height as desired
